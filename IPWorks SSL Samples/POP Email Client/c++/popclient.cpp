...
class MyFileMailer: public SMTP
{
...
int main(int argc, char * argv[])
{
	...
	if (argc != 7) {
		...
		fprintf(stderr, "\n");
		fprintf(stderr, "  popserver   the name or address of the mail server (internet post office server)\n");
		fprintf(stderr, "  port        the port of the mail server\n");
