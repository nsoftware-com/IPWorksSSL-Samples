...
class httpurlDemo {
  private static Http http1 = new nsoftware.async.IPWorksSSL.Http();

  private static void http1_OnSSLServerAuthentication(object sender, nsoftware.async.IPWorksSSL.HttpSSLServerAuthenticationEventArgs e) {
    if (e.Accept) return;
