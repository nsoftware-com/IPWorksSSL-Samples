object FormEchoclient: TFormEchoclient
  ...
  object ipsSSLClient1: TipsSSLClient
    FirewallPort = 80
    SSLCertStore = 'MY'
    OnConnected = ipsSSLClient1Connected
    OnDataIn = ipsSSLClient1DataIn
    OnDisconnected = ipsSSLClient1Disconnected
    OnError = ipsSSLClient1Error
    OnReadyToSend = ipsSSLClient1ReadyToSend
    OnSSLServerAuthentication = ipsSSLClient1SSLServerAuthentication
    Left = 56
    Top = 272
  end
end
