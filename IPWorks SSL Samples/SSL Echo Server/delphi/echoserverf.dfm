object FormEchoserver: TFormEchoserver
  Left = 321
  Top = 119
  Caption = 'SSL Echo Service Server'
  ClientHeight = 305
  ClientWidth = 399
  Color = clBtnFace
  ...
  object ipsSSLServer1: TipsSSLServer
    SSLCertStore = 'MY'
    OnConnected = ipsSSLServer1Connected
    OnDataIn = ipsSSLServer1DataIn
    OnDisconnected = ipsSSLServer1Disconnected
    OnError = ipsSSLServer1Error
    Left = 168
    Top = 32
  end
end
