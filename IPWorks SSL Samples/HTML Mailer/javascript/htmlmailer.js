...
async function main() {
	...
	if(argv.length < 9 || argv.length > 16) {
		...
		console.log("Example: node htmlmailer.js -u test@mydomain.com -p mypassword -s test -m \"<b>Hello</b>, my name is <i>Tom</i>\" -a \"C:\\File\\To\\Attach.jpg\" smtp.gmail.com sender@mail.com recipient1@gmail.com,recipient2@gmail.com");
		process.exit();
	} 

	const htmlmailer1 = new ipworksssl.htmlmailer();
