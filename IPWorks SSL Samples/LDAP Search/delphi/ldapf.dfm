object FormLdap: TFormLdap
  ...
  object ipsLDAP1: TipsLDAP
    SSLCertStore = 'MY'
    OnSearchComplete = ipsLDAP1SearchComplete
    OnSearchResult = ipsLDAP1SearchResult
    OnSSLServerAuthentication = ipsLDAP1SSLServerAuthentication
    OnSSLStatus = ipsLDAP1SSLStatus
    Left = 136
    Top = 136
  end
end
