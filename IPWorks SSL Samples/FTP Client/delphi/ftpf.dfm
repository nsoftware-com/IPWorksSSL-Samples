object FormFtp: TFormFtp
  ...
  object ipsFTP1: TipsFTP
    SSLCertStore = 'MY'
    OnDirList = ipsFTP1DirList
    OnEndTransfer = ipsFTP1EndTransfer
    OnPITrail = ipsFTP1PITrail
    OnSSLServerAuthentication = ipsFTP1SSLServerAuthentication
    OnStartTransfer = ipsFTP1StartTransfer
    OnTransfer = ipsFTP1Transfer
    Left = 276
    Top = 12
  end
end
