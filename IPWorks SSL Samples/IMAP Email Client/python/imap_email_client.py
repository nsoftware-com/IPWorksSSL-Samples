...
if len(sys.argv) != 5:
  print("usage: imap_email_client.py server port username password\r\n")
  ...
  print("\r\nExample: imap_email_client.py 127.0.0.1 993 username password")
else:
  try:
    imap = IMAP()
    ...
    imap.set_mail_port(int(sys.argv[2]))
    imap.set_user(sys.argv[3])
    imap.set_password(sys.argv[4])
