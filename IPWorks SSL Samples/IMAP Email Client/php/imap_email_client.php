...
<html>
<head>
<title>IPWorks SSL 2022 Demos - IMAP Email Client</title>
<link rel="stylesheet" type="text/css" href="stylesheet.css">
<meta name="description" content="IPWorks SSL 2022 Demos - IMAP Email Client">
</head>
...
<?php
require_once('../include/ipworksssl_imap.php');
require_once('../include/ipworksssl_const.php');

?>

<?php
	class MyIMAP extends IPWorksSSL_IMAP
	{
...
<table width="90%">
 ...
 <tr><td>Port:        <td><input type=text name=port value="<?php echo isset($_POST["port"])?$_POST["port"]:""; ?>" size=20>
...
<div id="footer">
<center>
IPWorks SSL 2022 - Copyright (c) 2024 /n software inc. - For more information, please visit our website at <a href="http://www.nsoftware.com/?demopg-ISPHA" target="_blank">www.nsoftware.com</a>.
</center>
</div>
